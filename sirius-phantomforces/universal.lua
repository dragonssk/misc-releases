-- This file was generated using StepBroSecure v13.5.9

-- Radiant Free
-- dssk was here
-- https://discord.gg/phantomforces

local o_request
o_request = hookfunction(syn.request, function(args)

    -- ownage and awesomesaucing
    if args.URL then
        if args.URL == 'https://raw.githubusercontent.com/shlexware/Sirius/request/library/esp/esp.lua' then
        ...
        elseif args.URL == 'http://127.0.0.1:6463/rpc?v=1' then
            return
        end
    end

    return o_request(args)
end)
...
-- ui
local window = uiLibrary:MakeWindow({ Name = "Sirius", HidePremium = false, SaveConfig = true, ConfigFolder = "Sirius" });
do
